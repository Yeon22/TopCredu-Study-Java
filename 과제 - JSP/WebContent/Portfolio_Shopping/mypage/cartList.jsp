...
<article>
	<h2>장바구니 목록(Cart List)</h2>
	<form name="formm" method="post">
		<c:choose>
			<c:when test="${cartList.size() == 0}">
				<h3 style="color: red; text-align: center; font-weight: bold; font-size: 1.45em;">장바구니가 비었습니다.</h3>
			</c:when>
			<c:otherwise>
				<table id="cartList">
					<tr>
					...
					<tr>
						<td>
							<a href="ShoppingServlet?command=product_detail&pseq=${cartVO.pseq}"></a>
							<h3>${cartVO.pname}</h3>
						</td>
