...
public class QnaDAO {
	...
	public ArrayList<QnaVO> listQna(String id){
		...
		String sql = "select * from pofol_qna where id=? order by qseq desc";
	...
	public QnaVO getQna(int seq) {
		QnaVO qnaVO = null;
		String sql = "select * from pofol_qna where qseq=?";
	...
	public void insertQna(QnaVO qnaVO, String session_id) {
		String sql = "insert into pofol_qna(qseq, subject, content, id) values(pofol_qna_seq.nextval, ?, ?, ?)";
	...
	public ArrayList<QnaVO> listAllQna(){
		ArrayList<QnaVO> qnaList = new ArrayList<QnaVO>();
		String sql = "select * from pofol_qna order by indate desc";
	...
	public void updateQna(QnaVO qnaVO) {
		String sql = "update pofol_qna set reply=?, rep='2' where qseq=?";
